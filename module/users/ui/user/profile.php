...
$user_servers = $USER ['user_servers'];
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>Signature</td>
								<td><pre><?php echo $user_detail['signature']; ?></pre></td>
							</tr>
							<tr>
                                        ...
                                        <?php
																																					...
																																					if (count ( $user_projects ) > 0) {
																																						...
																																						foreach ( $user_projects as $project ) {
																																							...
																																							$count ++;
																																							if ($count >= $maxshow) {
																																								echo '<tr><td> you have access to  total <span class="badge">' . count ( $user_projects ) . '</span> projects. For More Please Browse Projects! </td></tr>';
																																								break;
																																							}
																																						}
																																					} else {
                                        ...
                                        <?php
																																					...
																																					if (count ( $user_servers ) > 0) {
																																						...
																																						foreach ( $user_servers as $server ) {
																																							...
																																							$count ++;
																																							if ($count >= $maxshow) {
																																								echo '<tr><td colspan="2"> you have access to  total  <span class="badge">' . count ( $user_servers ) . '</span> servers. For More Please Browse Servers! </td></tr>';
																																								break;
																																							}
																																						}
																																					} else {
