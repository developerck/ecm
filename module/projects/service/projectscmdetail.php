 ...
 * @since	    2014
 * @module      projects
 * @service		projectscmdetail
 */
namespace module\projects\service;

class ProjectSCMDetail extends \module\projects\ProjectsService {
	public $table = 'project_scmdetail';
    public $tablecol = '';
	...
	// get list
	public function getSCMDetailByProjectId($id) {
		try {
