          ...
          ?>
			<div class="panel panel-info">
				<div class="panel-heading">
					Projects <?php echo $cntrlobj->getHelpText('help_projectlist',$cntrlobj->module);?>
				</div>
				<!-- /.panel-heading -->
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php foreach($format_data[ 'data'] as $record){
								    if(array_key_exists( 'NORECORD',$record)){ echo '<tr ><td class="norecord" colspan="5">'.$record[ 'NORECORD']. '</td></tr>';
                                    }else{
                                    	$buttonarr = array();
                                    	...
                                    	$buttonarr[] = '<a class="ajaxmodel" style="cursor:pointer" data-target="modal" data-contentid="modal_content"  data-url= "'.$CNF->wwwroot.'projects/project/getProjectInfoById" data-param=\'{"id":'.$record ['id'] .'}\' onclick="ajaxModal(this);"><span class="glyphicon glyphicon-info-sign"></span></a>';
